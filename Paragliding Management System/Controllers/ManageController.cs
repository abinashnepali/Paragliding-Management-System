...
namespace Paragliding_Management_System.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(IndexViewModel model)
        {
            ...
            {
                var setFnameResult = SetFirstNameAsync(user, model.FirstName);
                if (!setFnameResult.Succeeded)
                {
            ...
            {
                var setLnameResult = SetLastNameAsync(user, model.LastName);
                if (!setLnameResult.Succeeded)
                {
            ...
            {
                var setUnameResult = await _userManager.SetUserNameAsync(user, model.Username);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> EditIndex(IndexViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
            ...
            StatusMessage = "Your profile has been updated";
            return RedirectToAction(nameof(EditIndex), new { Id = model.Id});
        }
        ...
        public IdentityResult SetFirstNameAsync(AppUser user, string firstName)
        {
            try
            {
                if (user == null)
        ...
        public IdentityResult SetLastNameAsync(AppUser user, string lastName)
        {
            try
            {
                if (user == null)
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("Paragliding_Management_System"),
